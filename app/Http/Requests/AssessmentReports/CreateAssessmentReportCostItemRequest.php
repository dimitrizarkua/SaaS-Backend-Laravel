...
/**
 * Class CreateAssessmentReportCostItemRequest
 *
 ...
 * )
 */
class CreateAssessmentReportCostItemRequest extends ApiRequest
{
    /**
    ...
    {
        return [
            'assessment_report_costing_stage_id' => 'required|integer|exists:assessment_report_costing_stages,id',
