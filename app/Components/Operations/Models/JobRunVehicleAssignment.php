 ...
 * @OA\Schema(
 *     type="object",
 *     required={"job_run_id","vehicle_id","created_at"}
 * )
 */
class JobRunVehicleAssignment extends Model
{
    use HasCompositePrimaryKey;

    const UPDATED_AT = null;

    protected $primaryKey = ['job_run_id', 'vehicle_id'];
     ...
     * @OA\Property(property="driver_name", type="string", description="Driver name", example="John Smith")
