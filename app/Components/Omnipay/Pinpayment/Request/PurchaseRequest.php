 ...
 * * Optional capture    Whether or not to immediately capture the charge ("true" or "false"). If capture is false an
 * authorisation is created. Later you can capture. Authorised charges automatically expire after 5 days. Default value
 * is "true".
 *
 * and one of the following:
 *
 * * card              The full details of the credit card to be charged (CreditCard object)
 * * card_token        Token of the card to be charged, as returned from the card tokens API or customer API.
 * * customer_token    Token of the customer to be charged, as returned from the customers API.
 *
 * Example:
 *
 * <code>
 ...
 * $gateway = Omnipay::create('\FullQualifiedNameSpace');
 *
