...
/**
 * Class JobTaskVehicleAssignment
 *
 * @mixin \Eloquent
 *
 ...
 * @OA\Schema(
 *     type="object",
 *     required={"job_task_id","vehicle_id","created_at"}
 * )
 */
class JobTaskVehicleAssignment extends Model
{
    use HasCompositePrimaryKey;

    const UPDATED_AT = null;

    protected $primaryKey = ['job_task_id', 'vehicle_id'];
