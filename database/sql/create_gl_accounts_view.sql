...
SELECT gl_accounts.id as gl_account_id, gl_accounts.name as gl_account_name, gl_accounts.code as gl_account_code,
locations.id as location_id, locations.name as location_name,
account_types.id as account_type_id, account_types.name as account_type_name,
...
WHERE
  accounting_organizations.is_active AND gl_accounts.is_active
